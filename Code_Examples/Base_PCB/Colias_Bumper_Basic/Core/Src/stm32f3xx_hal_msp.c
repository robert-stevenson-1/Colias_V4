...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA2     ------> ADC1_IN3
    */
    HAL_GPIO_DeInit(GPIOA, PIN_BUMPER_R_ADC1_IN_Pin|PIN_BUMPER_M_ADC1_IN_Pin|PIN_BUMPER_L_ADC1_IN_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PA6     ------> ADC2_IN3
    */
    HAL_GPIO_DeInit(GPIOA, PIN_AMB_LIGHT_Q3_ADC2_IN1_Pin|PIN_AMB_LIGHT_Q4_ADC2_IN2_Pin|PIN_BAT_VOLTAGE_ADC2_IN3_Pin);
